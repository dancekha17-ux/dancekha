...
二、身份審核與聚落共創機制：
1.【真實身份與專業資料】
您承諾於平台提供之學經歷、教學經驗、演出、比賽、證照或其他相關資料均為真實且完整。如經查證有重大不實情形，本平台得暫停合作。
2. 🏝️【引導者聚落】打造品牌專頁
...
3. 🌱【島嶼種子計畫】共築聚落，共享成長
為共同累積平台內容與文化資產，並協助您建立品牌影響力，您同意於進駐起三個月內，一次性提供 5 支優質教學短片（每支約 8 分鐘）無償授權本平台使用，作為平台付費會員專區之學習內容。本項授權僅限於平台及相關推廣用途，影片之著作權及其他智慧財產權仍歸您所有。本計畫內容由平台統一規劃與營運，會員訂閱收入主要用於平台整體維運與行銷等。平台將持續透過會員服務及品牌推廣，協助提升您的品牌曝光與後續課程發展。
...
3. 結算與發放: 平台於每月最後一日結算當月已結束與完成之服務總營收。扣除上述平台營運基本費(7%)，第三方金流實支實付手續費(預估3%)，及國內跨行轉帳手續費(每筆最高 NT$15)後，於次月 10 日匯入您指定的撥款帳戶。(註: 非台灣境內帳戶之國際跨境轉帳手續費或電匯規費，將於當期撥款中逕行扣抵。)
...
四、 服務發佈與內容擔保規範：
1. 自主權與內容擔保：平台充分尊重您的專業，您可在本平台開辦與發售實體課程、線上課程、演出票券、空間出租等多元服務，並自由規劃名稱、介紹、時間與價格。您保證所提供之教學內容、編舞、音樂、講義或演出皆為原創或已取得合法授權。若引發版權糾訪，由您全權承擔相應法律責任。
...
八、個人資料保護：
雙方應嚴格遵守個資法令，本平台僅於營運目的內合法使用您的資料。您因課程合法取得之學員個資，僅得用於履約管理與合理品牌維護；非經學員同意，嚴禁將學員個資出售、轉讓予第三人，或進行與課程經營無關之商業用途。若因違反個資法導致平台受損，需承擔法律及賠償責任。
