...
3.🌱【島嶼種子計畫】共創承諾：
我們深知您與團隊創立品牌的艱辛，因此我們僅收取極低 7% 的分潤補貼平台維護費，這近乎是我們為了維持系統、金流與基本營運所能做出的最大讓利與奉獻。為了與您一同在這個溫暖的舞蹈島嶼立足，願我們成為彼此最堅實的合夥人。您同意於進駐前三個月內，提供 5 支優質內容的教學短片（每支 5 ~ 8 分鐘，含核心動作拆解與跟跳）。這 5 支短片將作為平台付費會員的專屬福利，由平台全力為您行銷曝光。這不僅是您對舞島社群的灌溉，更是您在初期精準圈粉、無痛累積第一批核心付費學員的最強敲門磚。
...
四、 服務發佈與內容擔保規範
1. 自主權與內容擔保: 平台充分尊重您的專業,您可在本平台開辦與發售實體課程、線上預錄課程、演出票券、空間出租等多元服務,並自由規劃名稱、介紹、時間 with 價格。您保證所提供之教學內容、編舞、音樂、講義 or 演出皆為原創或已取得合法授權。若引發版權糾紛,由您全權承擔相應法律責任。
2. 安全與場地合規: 您在引導實體、線上課程、舉辦演出或進行空間出租時,有責任維護現場秩序、設備安全與參與者身體安全。如因教學疏忽、活動規劃不當 or 空間設備維護不良導致人員受傷或財物受損,相關法律與賠償責任由您承擔。
3. 取消與改期義務: 服務一經刊登且有消費者購買,除不可抗力因素外,您應依約履行。如需改期或取消,須於服務開始前 48 小時通知平台與消費者,並配合平台進行後續退費或補救事宜。

五、 ⚖️ 獨立承攬合作關係：
雙方明確確認本合作性質為「獨立承攬與平台撮合關係」,不構成勞基法上之僱傭、勞雇、派遣、合夥 or 代理關係。您享有完全的排班、定價與授課自主權,須自行處理個人之勞健保投保與退休金提撥,不得向本平台主張任何勞基法上之員工福利或雇主責任。

六、 📝 知識產權與著作權歸屬
1. 您的著作權: 您在平台上傳、發佈的所有照片、原創編舞影片、講義、文宣等內容,其智慧財產權 100% 歸您所有。
2. 平台的推廣授權: 您同意無償授權舞島咖於官方網站、社群媒體(Instagram、Facebook)、電子報等行銷宣傳中,合理使用您的公開簡介、劇照及教學演出精彩片段,作為 platform 推廣引流之用。

七、 平台守護機制(終止與合規)
1. 若有以下情形,本平台有權暫停您的帳號、隱藏地圖點位並終止合作:
2. 經學員或消費者檢舉且查證屬實之騷擾、歧視、或違反社會善良風俗之行為。
3. 刻意引導學員或消費者私下交易、規避平台金流之行為。
4. 惡意不履行進駐承諾(如未提供基礎教學影片)或經查證履歷與服務內容有嚴重偽造者。`;
