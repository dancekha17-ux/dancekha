...
const faqs = [
  {
    q: "加入舞島咖需要費用嗎？",
    a: "為維持系統維護、影音串接、金流與行銷的穩定運作，平台需投入相應的營運成本。\n\n目前平台處於測試階段，我們誠摯邀請您與團隊率先進駐，作為種子夥伴共同打造舞蹈生態圈。未來平台支援實體與線上課程推廣，相關營運費用與合作規範，我們將於後續完整說明。期待與您攜手共創！",
  },
  {
  ...
  {
    q: "與平台的合作模式為何呢？",
    a: "本平台致力於與您共同打造兼具文化價值與品牌影響力的數位舞蹈聚落，詳細合作模式會在「引導者聚落合作約定」中完整說明。",
  },
  {
    q: "需要多久才能完成申請上線？",
