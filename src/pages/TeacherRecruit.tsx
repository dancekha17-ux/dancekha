...
const valueCards = [
  ...
  },
  {
    ...
    title: "讓專業獲得應有回報",
    description:
      "我們珍惜每一位引導者的心血，課程與服務收益最高為 90% 分潤。我們深信，只有當創造者無後顧之憂，舞蹈藝術才能在純粹且支持性的環境中持續綻放，讓每一份專業投入，都能獲得最直接、實質的回報。",
  },
  {
    icon: Sprout,
    emoji: "🌱",
...
const faqs = [
  {
    q: "加入舞島咖需要費用嗎？",
    a: "建立引導者品牌專頁完全免費。我們只在您透過平台開課與成交時，依分潤比例收取平台營運費，讓您零風險開始。",
  },
  {
  ...
  {
    q: "分潤的計算方式為何？",
    a: "引導者師資團隊最高可達 90% 收益分潤。詳細方式會在簽署「引導者聚落合作協議」中完整說明。",
  },
  {
    q: "需要多久才能完成審核並上線？",
