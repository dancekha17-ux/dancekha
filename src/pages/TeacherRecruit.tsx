...
const faqs = [
  {
    q: "加入舞島咖需要費用嗎？",
    a: "加入與建置品牌專頁完全免費！\n目前平台為測試階段，誠摯邀請您作為首批種子夥伴進駐，共創舞蹈文化聚落。\n未來任何收費功能推出前，我們都會提前通知並由您自主選擇是否使用。現階段您可以放心體驗，無須負擔任何費用！",
  },
  {
    q: "我可以同時保留自己的教學品牌與社群嗎？",
    a: "當然可以。舞島咖是您現有品牌的延伸與擴大，讓您的舞蹈專業跨越時間與地域，持續創造影響力，協助您觸及更多文化探索者。",
  },
  {
    q: "與平台的合作模式為何呢？",
    a: "我們是您的「數位曝光與工具夥伴」，非經紀或僱傭關係。\n在舞島咖，您保有 100% 的品牌獨立性與定價自由。我們專注於為您提供數位系統工具、跨界合作等；您則專注於優質的教學與創作。雙方互惠互助，詳細內容可參閱「引導者聚落合作約定」。",
  },
  {
    q: "需要多久才能完成申請上線？",
    a: "完成基本資料填寫後送出申請，舞島咖團隊預計於 2 個工作天內完成內容確認並協助您公開頁面。",
  },
  {
    q: "我不是專職老師，是否也能加入？",
    a: "歡迎。只要您願意分享文化舞步與故事，無論是工作室、舞團或推廣社團，都能在這座島嶼上找到位置。",
  },
];
