...
const MAP_REGIONS: MapRegion[] = [
  ...
  { id: "china",    name: "中國",   lat: 35.8617,  lng: 104.1954,  offsetX: -3.9, offsetY: 11.9, country: "中國", dance: "古典舞 & 民族民間舞", desc: "長袖飛舞、水袖弄影，在行雲流水的吐納與身韻間，展現東方身體的寫意美學。", queryParam: "China", keywords: ["中國", "China", "中國古典舞", "民族"] },
